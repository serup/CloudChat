...
//                }, 8000); // timeout after max 
    ...
    /// $cat DD_PROFILE_TOAST_ATTRIBUTES.xml | grep -e '<PhysicalDataElementName>' | sed -e 's/<PhysicalDataElementName>/\"/' | sed -e 's/<\/PhysicalDataElementName>/\",/'
            ...
            ulsettings.append($('<div id="ProfilePage" >'
                                ...
                                + '  </tr>'
                                + '  <tr>'
                                + '     <td ><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-user" style="font-size: 18px"></i></h3><b>UserName</b></td><td><span id="_username" onclick="settings_view_this.SettingsElementClicked.notify('+ "'_username'" +');">'+strusername+'</span></td>'
                                + '  </tr>'
                                + '  <tr>'
                                + '     <td ><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-lock" style="font-size: 18px"></i></h3><b>Password</b></td><td><span id="_username" onclick="settings_view_this.SettingsElementClicked.notify('+ "'_username'" +');">'+strpassword+'</span></td>'
                                + '  </tr>'
				+ '  <tr>'
                                ...
                                + '  </tr>'
                                + '  <tr>'
                                + '     <td><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-home" style="font-size: 18px"></i></h3><b>Address</b></td><td><span id="userAddress">'+ strstreetname  + " " +  strstreetno + " , " + strpostalcode  + " " +  strcity +'</span></td>'
                                + '  </tr>'
                                + '  <tr>'
                                + '     <td><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-flag" style="font-size: 18px"></i></h3><b>Nationality</b></td><td><span id="userNationality">'+ strcountry  + " (" + strstate + ")" +'</span></td>'
                                + '  </tr>'
                                + '  <tr>'
                                + '     <td><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-earphone" style="font-size: 18px"></i></h3><b>Phone</b></td><td><span id="userPrimaryPhone">'+ strmobilephone +'</span></td>'
                                + '  </tr>'
                                + '  <tr>'
                                + '     <td><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-comment" style="font-size: 18px"></i></h3><b>Note</b></td><td><span id="userAbout">'+ strabout +'</span></td>'
                                + '  </tr>'
                                + '  <tr>'
                                + '     <td><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i>@</i></h3><b>Email</b></td><td><span id="userEmail">'+ stremail +'</span></td>'
                                + '  </tr>'
                                + '  <tr>'
                                + '    <td><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-info-sign" style="font-size: 18px"></i></h3><b>About</b></td><td><span id="userInfo"></span></td>'
                                + '  </tr>'
                                + '  <tr>'
                                + '    <td><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-barcode" style="font-size: 18px"></i></h3><b>ID</b></td><td>'+ UniqueIdFromSettings.small() +'<span id="userID"></span></td>'
                                + '  </tr>'
                                + '  <tr>'
                                + '    <td><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-time" style="font-size: 18px"></i></h3><b>Subscription Expires</b></td><td><span id="userCreationDate"></span></td>'
                                + '  </tr>'
                                + '  <tr>'
                                + '    <td><h3 style="margin-bottom: 0px; margin-top: 0px; margin-right: 0px; color:darkgray;"><i class="glyphicon glyphicon-barcode" style="font-size: 18px"></i></h3><b>Supervisor ID</b>'</td><td>+ strsupervisor.small() +'<span id="supervisor"></span></td>'
                                + '  </tr>'
                                + '</table>'
                                + '</div>'));
