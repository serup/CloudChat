...
(function () {
	...
	document.getElementById("panelUser").style.color="blue";
	document.getElementById("panelUser").innerHTML = document.getElementById("username").value;
	},

	logedinToServer : function (_this) {
		  if(_this.bServerLogIn == true){
			  document.getElementById("panelUser").style.color="blue";
			  //document.getElementById("panelUser").innerHTML = document.getElementById("uniqueId").value;
			  document.getElementById("panelUser").innerHTML = document.getElementById("username").value;
			  //document.getElementById("connectBtn").className = 'btn btn-default btn-block btn-success';
		  }
		  else {
			  document.getElementById("panelUser").style.color="yellow";
