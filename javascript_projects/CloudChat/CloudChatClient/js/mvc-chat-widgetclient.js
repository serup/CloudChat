...
(function () {
    ...
    ListView.prototype = {
	    ...
	    if(items !== 0){
			...
			if(items[key]._showdelivery === true){
				if(items[key]._timesend === 0){ // if received then show in left side
                                    ...
                                    if(items[key]._urlManagerImg === "")
                                        ullist.append($('<li class="left clearfix"><span class="chat-img pull-left"><img src="' + managerdefaultImg + '"  onError="this.onerror=null;this.src=\'images/user.png\';" height="60" width="auto" max-width="50" alt="User Avatar" class="img-circle" /></span><div class="chat-body clearfix"><div class="header"><small class="pull-right text-muted"><span class="glyphicon glyphicon-time"></span>' + items[key]._timereceived + '</small></div>' + '<p>' + items[key]._chatmsg + '</p><div class="header pull-right"></div><small class="text-muted">delivered: '+ items[key]._dest + '</small> <a ><span class="' + items[key]._strIconClass + '"> </span> </a><span><img src="images/'+ items[key]._dest + '.png" alt="Delivered User Avatar" class="img-rounded"  height="30" width="auto"  /></span></div>' + '</li>'));
                                    else
			...
			this._model._lastEntryTime = items[key]._timereceived;
                        if(items[key]._urlManagerImg === "")
                            ullist.append($('<li class="left clearfix"><span class="chat-img pull-left"><img src="' + managerdefaultImg + '" onError="this.onerror=null;this.src=\'images/user.png\';" height="60"  width="auto" max-width="50"  alt="User Avatar" class="img-circle" /></span><div class="chat-body clearfix"><div class="header"><small class="pull-right text-muted"><span class="glyphicon glyphicon-time"></span>' + items[key]._timereceived + '</small></div>' + '<p>' + items[key]._chatmsg + '</p><div class="header pull-right"></div></div>' + '</li>'));
                        else
