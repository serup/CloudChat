...
//small 80x80 2016-07-12 - image below 5kb
				...
				DED_PUT_ELEMENT   ( encoder_ptr, "type", "...") 
				DED_PUT_ELEMENT   ( encoder_ptr, "status", "created")
				DED_PUT_ELEMENT   ( encoder_ptr, "expiredate", "20180101")
				DED_PUT_ELEMENT   ( encoder_ptr, "creditor", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "terms", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "subscriptions", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "paymentdetails", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "notificationlevel", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "bankaccount", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "memberships", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "friendships", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "presence", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "location", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "context", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "schedule", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "deviceID", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "experience", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "skills", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "messagesboard", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "eventlog", "...")
				DED_PUT_ELEMENT   ( encoder_ptr, "supervisor", "754d148d0522659d0ceb2e6035fad6a8") // id is test id - should be fetched
		///- end toast elements
