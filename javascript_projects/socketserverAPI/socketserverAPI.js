...
//small 80x80 2016-07-12 - image below 5kb
				...
				DED_PUT_ELEMENT( encoder_ptr, "profile","status", "created");
				DED_PUT_ELEMENT( encoder_ptr, "profile","expiredate", "20180101");
				...
				DED_PUT_ELEMENT( encoder_ptr, "profile","friendships", "...");
				...
				DED_PUT_ELEMENT( encoder_ptr, "profile","experience", "...");
				DED_PUT_ELEMENT( encoder_ptr, "profile","skills", "...");
				DED_PUT_ELEMENT( encoder_ptr, "profile","messagesboard", "...");
				DED_PUT_ELEMENT( encoder_ptr, "profile","eventlog", "...");
				DED_PUT_ELEMENT( encoder_ptr, "profile","supervisor", "754d148d0522659d0ceb2e6035fad6a8");
		///- end toast elements
