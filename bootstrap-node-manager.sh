...
then
    ...
    echo "192.168.32.22   cloudchatmanager.dev.dops.local   puppet" | sudo tee --append /etc/hosts 2> /dev/null && \
    echo "192.168.32.23   cloudchatclient.dev.dops.local    puppet" | sudo tee --append /etc/hosts 2> /dev/null
