...
#    echo "fetch bamboo - needed since puppet wget is not working pt."
#    wget http://www.atlassian.com/software/bamboo/downloads/binary/atlassian-bamboo-4.4.0.tar.gz atlassian-bamboo-4.4.0.tar.gz; sudo mv atlassian-bamboo-4.4.0.tar.gz /usr/local/src/atlassian-bamboo-4.4.0.tar.gz
