    ...
    echo "192.168.31.16   hadoop1.dops.scanva.com          hadoop1" | sudo tee --append /etc/hosts 2> /dev/null && \
    echo "192.168.31.17   hadoop2.dops.scanva.com          hadoop2" | sudo tee --append /etc/hosts 2> /dev/null && \
    echo "192.168.31.18   hadoop.dops.scanva.com           hadoop" | sudo tee --append /etc/hosts 2> /dev/null && \
