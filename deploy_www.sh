...
cp -r /var/scanva/release/serup/CloudChat/javascript_projects/socketserverAPI /var/www/DOPS
cp -r /var/scanva/release/serup/CloudChat/codeblocks_projects/DataDictionary /var/www/DOPS
