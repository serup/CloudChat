 ...
 *
 */
public class DEDHeaders implements MultiValueMap<String, String>, Serializable {

	private static final long serialVersionUID = 7714648206828482587L;
	...
	private DEDHeaders(Map<String, List<String>> headers, boolean readOnly) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof DEDHeaders)) {
			return false;
		}
		DEDHeaders otherHeaders = (DEDHeaders) other;
	...
	/**
	 * Return a {@code DEDHeaders} object that can only be read, not written to.
	 */
	public static DEDHeaders readOnlyDEDHeaders(Map<String, List<String>> headers) {
		return new DEDHeaders(headers, true);
	}
