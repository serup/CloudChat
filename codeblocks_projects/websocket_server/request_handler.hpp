    ...
    namespace http {
		...
		public:
		  ...
		  void Set(const char* String) {
			MD5Context Context;
			Init(&Context);
			Update(&Context, (BYTE*)String, (DWORD)strlen(String));
			Final(&Context);
			CreateString();
		  }
        ...
        {
        public:
			static std::string md5_hash_challenge(int key_1, int key_2, u_char *value);
			static int get_number_from_string(const char *str);
