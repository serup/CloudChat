...
set shortmess=aoO
badd +1 testoutput
badd +77 DDDAdmin_test.cpp
badd +12 output
badd +0 makefile_ubuntu.mak
argglobal
silent! argdel *
edit output
...
exe 'vert 1resize ' . ((&columns * 59 + 91) / 182)
exe '2resize ' . ((&lines * 26 + 28) / 56)
exe 'vert 2resize ' . ((&columns * 59 + 91) / 182)
exe 'vert 3resize ' . ((&columns * 122 + 91) / 182)
argglobal
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((10 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 76 - ((37 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
