...
set shortmess=aoO
badd +1 testoutput
badd +86 DDDAdmin_test.cpp
badd +1 output
badd +17 makefile_ubuntu.mak
badd +62 bash\ -\ 1
badd +23 ~/GerritHub/CloudChat/codeblocks_projects/distributeddatadictionary/datadictionarycontrol.cpp
...
argglobal
silent! argdel *
edit ~/GerritHub/CloudChat/codeblocks_projects/distributeddatadictionary
...
exe 'vert 1resize ' . ((&columns * 48 + 116) / 233)
exe '2resize ' . ((&lines * 15 + 33) / 66)
exe 'vert 2resize ' . ((&columns * 87 + 116) / 233)
exe '3resize ' . ((&lines * 15 + 33) / 66)
exe 'vert 3resize ' . ((&columns * 136 + 116) / 233)
exe '4resize ' . ((&lines * 23 + 33) / 66)
exe 'vert 4resize ' . ((&columns * 136 + 116) / 233)
exe '5resize ' . ((&lines * 55 + 33) / 66)
exe 'vert 5resize ' . ((&columns * 96 + 116) / 233)
exe '6resize ' . ((&lines * 8 + 33) / 66)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((14 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 17 - ((10 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
...
71
normal! zo
let s:l = 86 - ((44 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
