...
exe 'vert 1resize ' . ((&columns * 114 + 136) / 272)
exe '2resize ' . ((&lines * 26 + 40) / 80)
exe 'vert 2resize ' . ((&columns * 113 + 136) / 272)
exe '3resize ' . ((&lines * 51 + 40) / 80)
exe 'vert 3resize ' . ((&columns * 113 + 136) / 272)
exe 'vert 4resize ' . ((&columns * 43 + 136) / 272)
argglobal
setlocal keymap=
setlocal noarabic
...
71
normal! zo
let s:l = 342 - ((46 * winheight(0) + 39) / 78)
