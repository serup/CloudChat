...
BOOST_AUTO_TEST_CASE( addSmallAndLargeAttributesOver3BFifiles)
{
	cout<<"BOOST_AUTO_TEST_CASE( addSmallAndLargeAttributesOver3BFifiles )\n{"<<endl;
...
BOOST_AUTO_TEST_CASE( fetchAttributFrom3BFi)
{
	cout<<"BOOST_AUTO_TEST_CASE( fetchAttributFrom3BFi)\n{"<<endl;
	...
	BOOST_CHECK(ptestDataDictionaryControl->addAttributToBlockRecord(transGuid,ptListOfBlockRecords, maxBlockRecordSize, realmName, attributName2, attributValue2)); 
	cout << "BlockRecord size after 2 atrribut add : " << maxBlockRecordSize << endl;
	BOOST_CHECK(ptestDataDictionaryControl->addAttributToBlockRecord(transGuid,ptListOfBlockRecords, maxBlockRecordSize, realmName, attributName3, FotoAttributValue)); 
	cout << "BlockRecord size after 3 atrribut add : " << maxBlockRecordSize << endl;
	...
	cout << "INFO: ftgt should beable to assemble across multiple .BFi files " << endl;
	pair<std::string, std::vector<unsigned char>> pairAttribut = ptestDataDictionaryControl->ftgt("F9C23762ED2823A27E62A64B95C024EF./profile/foto");
	cout << "Attribut name : " << pairAttribut.first << endl;
