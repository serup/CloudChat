...
//	boost::shared_ptr< std::vector< pair<unsigned char*, int> > > splitAttributIntoDEDchunks(long &aiid, std::string attributName, std::vector<unsigned char>& attributValue, long maxDEDchunkSize);
