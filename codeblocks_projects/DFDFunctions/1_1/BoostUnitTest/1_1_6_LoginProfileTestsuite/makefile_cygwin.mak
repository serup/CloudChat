...
#
#
CC=g++ -g -o bin/Debug/1_1_6_test 1_1_6_LoginProfile_test.cpp ../../1_1_Profile.hpp ../../md5.h ../../base64.h ../../base64.cpp ../../1_1_Profile.cpp ../../../../DataBaseControl/databasecontrol.hpp ../../../../DataBaseControl/databasecontrol.cpp ../../../../DataEncoderDecoder/DataEncoderDecoder/DataEncoder.h ../../../../DataEncoderDecoder/DataEncoderDecoder/DataEncoder.cpp ../../../../DataEncoderDecoder/DataEncoderDecoder/compression-lib/compression.h ../../../../DataEncoderDecoder/DataEncoderDecoder/compression-lib/compression.cpp ../../../../websocket_server/wsclient/wsclient.cpp ../../../../websocket_server/wsclient/wsclient.hpp ../../../../websocket_server/dataframe.hpp ../../../../websocket_server/dataframe.cpp ../../../../websocket_server/dataframe_parser.hpp ../../../../websocket_server/dataframe_parser.cpp ../../../../websocket_server/header.hpp ../../../../websocket_server/participant.hpp ../../../../websocket_server/reply.hpp ../../../../websocket_server/reply.cpp ../../../../websocket_server/request.hpp ../../../../websocket_server/request_handler.hpp ../../../../websocket_server/request_handler.cpp ../../../../websocket_server/request_parser.hpp ../../../../websocket_server/request_parser.cpp ../../../../websocket_server/room.hpp ../../../../websocket_server/room.cpp ../../../../websocket_server/server.hpp ../../../../websocket_server/server.cpp ../../../../websocket_server/session.hpp ../../../../websocket_server/session.cpp -L"/cygdrive/c/cygwin/usr/local/lib/" -DWIN32_LEAN_AND_MEAN -D__DEBUG__ -D_WIN32 -D_WIN32_WINNT -D__USE_W32_SOCKETS -D__CYGWIN__ -D__SunOS -D__MINGW32__ -D__MSABI_LONG=long -lws2_32 -lboost_system.dll -lboost_signals.dll -lboost_thread.dll -lboost_filesystem.dll -std=gnu++11 
TEST=./bin/Debug/1_1_6_test.exe 
...
all:
	...
	@ echo "_1161_Authentication      "
	@ echo "_11611_FetchProfile       " 
	@ echo "_11612_MatchPassword      "
	@ echo "_1162_AccountValidation   "
	@ echo "_1163_UpdateProfileStatus "
	@ echo "_1164_WriteLog            " 
	@ echo "LoginAndUpdate            "
	@ echo "------------------------"
	...
	@ echo " see output : make -f makefile_cygwin.mak run unittest=\"_1161_Authentication \&&\" "
	@ echo "------------------------"
