...
BOOST_AUTO_TEST_CASE(Base64DecodeEmbedded_foto)
{
    C1_1_Profile C11;
    bool bResult = false;
    ...
    SetDir();
         ...
         // take the embedded foto from record_value and write to image file in /var/www/img/xxxxx.jpg, then give URI to this extracted file instead of base64 embedded image - this is due to performance issues - it takes too long in JavaScript to receive a large base64 image inside DED
        //+
        {
            //Elements fotoelement;
            //bResult = CDbCtrl.fetch_element(record_value,(std::string)"foto", fotoelement);
            //std::string _strfoto(fotoelement.ElementData.begin(),fotoelement.ElementData.end());
            std::string _strfoto("data:image/jpeg;base64,");
            // Since a foto in the database is as base64 embedded, then take the embedded foto from record_value and write to image file in /var/www/img/xxxxx.jpg, then give URI to this extracted file instead of base64 embedded image - this is due to performance issues - it takes too long in JavaScript to receive a large base64 image inside DED
            // The javascript must add ip example: backend.scanva.com/img/xxxxx.jpg
            // Check if image in database is of following type : data:image/jpeg;base64,
            std::string s = "data:image/jpeg;base64,";
            std::string::size_type i = _strfoto.find(s);
            if (i != std::string::npos) {
               _strfoto.erase(i, s.length()); // trim off the header
                cout << "Embedded image found, now extract and put in /var/www/img/xxxxx.jpg" << endl;
                std::vector<BYTE> decodedData = base64_decode(_strfoto);
    ...
    // First manually inspect if image is a picture of serup with cap, then continue

    boost::filesystem::remove( "test.jpg" );
